...
class ProfileHeader: UICollectionReusableView {
    ...
    private lazy var postsLabel: UILabel = {
        ...
        label.attributedText = attributedStatusText(value: 1, label: "posts")
        return label
    }()
    ...
    private lazy var followersLabel: UILabel = {
        ...
        label.numberOfLines = 0
        label.textAlignment = .center
        label.attributedText = attributedStatusText(value: 1, label: "followers")
        return label
    }()
    ...
    private lazy var followingLabel: UILabel = {
        ...
        label.numberOfLines = 0
        label.textAlignment = .center
        label.attributedText = attributedStatusText(value: 1, label: "following")
        return label
    }()
